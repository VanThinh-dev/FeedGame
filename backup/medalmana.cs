...
//     {
//         var ud = AuthManager.Instance?.CurrentUserData;
//         if (ud == null) { Debug.LogWarning("[MedalManager] Khong co UserData."); return; }
...
//         switch (type)
//         {
//             case MedalType.Gold:   ud.goldMedals++;   field = "goldMedals";   break;
//             case MedalType.Silver: ud.silverMedals++; field = "silverMedals"; break;
//             default:               ud.bronzeMedals++; field = "bronzeMedals"; break;
//         }
...
//             {
//                 if (task.IsFaulted)
//                     Debug.LogError($"[MedalManager] Loi luu {field}: {task.Exception?.Message}");
//                 else
//                     Debug.Log($"[MedalManager] Da luu {field} = {newCount}");
//             });
//     }
// }